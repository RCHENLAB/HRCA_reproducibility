...
rna0=scv.read(f'{indir}/{cell}_rna-emb.h5ad')
atac0=scv.read(f'{indir}/{cell}_atac-emb.h5ad')
...
#rna_cell=rna0.obs.index.difference(dbt.index)
#atac_cell=atac0.obs.index.difference(dbt.index)

rna_cell=rna0.obs.index.difference(dbt_full)
atac_cell=atac0.obs.index.difference(dbt_full)
...
combined0=scv.read(f'{indir}/{cell}_combined-emb.h5ad')
...
#combined.obs.loc[atac.obs.index,"svm_celltype"]=""
