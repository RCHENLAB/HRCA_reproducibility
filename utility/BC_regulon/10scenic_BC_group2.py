...
work_dir=f'/storage/chentemp/wangj/scenic/{celltype}_group2' # f'/storage/chentemp/wangj/scenic/major'
tmp_dir=f'/storage/chentemp/jw_{celltype}_group2'
...
rna_h5ad=f'/storage/chenlab/Users/junwang/human_meta/data/ref/snRNA_{celltype}_downsample{downsample}.h5ad'
rna=sc.read_h5ad(rna_h5ad)
#label="cluster2"
rna.obs["celltype"]=rna.obs[label]
#rna=rna[rna.obs["celltype"]!="nGnG"]
if celltype == "BC":
...
atac_h5ad=f'/storage/chenlab/Users/junwang/human_meta/data/ref/snATAC_{celltype}_downsample{downsample}.h5ad'
...
atac.obs["celltype"]=atac.obs[label1]

atac=atac[atac.obs["celltype"]!="nGnG"]
...
#        index_order = ['Glycinergic', 'GABAergic', 'nGnG', 'Both'],
        index_order = ['OFF', 'ON'],
        figsize = (10, 40),
...
plot_rss(scplus_obj, 'celltype_filtered', num_columns=4, top_n=10, figsize = (10, 40), save=f'{work_dir}/rss.png')


data=scplus_obj.uns['RSS']['celltype_filtered']
data.T.to_csv(os.path.join(work_dir, 'scenicplus/RSS_celltype_filtered'),sep="\t")
