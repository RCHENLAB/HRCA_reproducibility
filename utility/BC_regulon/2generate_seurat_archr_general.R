...
dirIn=paste0("/storage/chenlab/Users/junwang/human_meta/data/proj4_clean1_",ct,"/h5ad/")
dir.create(dirIn,recursive = TRUE)

combined.peaks=readRDS(paste0("/storage/chenlab/Users/junwang/human_meta/data/proj4_clean1_",ct,"/peakset_clusters.rds"))
bc=read.table(file=paste0("/storage/chenlab/Users/junwang/human_meta/data/proj4_clean1_",ct,"/CB_afterFlt_",ct),header=T,comment.char="")
i=0
...
print(paste0("no cb in sample ", dir))
