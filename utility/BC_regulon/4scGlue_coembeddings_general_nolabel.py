...
atac.obs[rna_batch]=atac.obs[atac_batch]
#atac.obs["cell_type"]=atac.obs[atac_label]

atac.obs[rna_label]="Unknown"
...
#sc.pl.embedding(combined, basis="X_umap", color=["leiden","cell_type", "domain"],ncols=1,frameon=False,save=f'_{celltype}_combined_cpu.png', palette="tab20")

#sc.pl.embedding(combined, basis="X_umap", color=["leiden", "domain"],ncols=1,frameon=False,save=f'_{celltype}_combined_cpu.png', palette="tab20")
sc.pl.embedding(combined, basis="X_umap", color=[rna_batch],ncols=1,frameon=False,save=f'_{celltype}_combined_batch.png', palette="tab20")

sc.pl.embedding(combined, basis="X_umap", color=["leiden"],ncols=1,frameon=True,save=f'_{celltype}_combined_leiden.png', palette="tab20")
sc.pl.embedding(combined, basis="X_umap", color=[rna_label],ncols=1,frameon=False,save=f'_{celltype}_combined_label.png', palette="tab20")
sc.pl.embedding(combined, basis="X_umap", color=["domain"],ncols=1,frameon=False,save=f'_{celltype}_combined_domain.png', palette="tab20")
