...
my %peak_all=();
my %peak_var=();
my $peak = "sc_human_retina/data/eQTL/all_TRUE_hg19_retina_gencodeHg19_format_eQTL_atlas"; #$ARGV[0]; #####variant peak annotation
open(INPUT,$peak);
while(my $line = <INPUT>){
chomp $line;
my @info = split(/\s+/,$line);
...
my $peak_all = "/storage/chenlab/Users/junwang/human_meta/data/finemap_eQTL/all_TRUE_hg19_retina_gencodeHg19_PIP_anno_eQTL"; #$ARGV[1]; ####variant annotation
my %peak;
my %gene;
open(INPUT,$peak_all);
<INPUT>;
...
my $file = "/storage/chenlab/Users/junwang/human_meta/data/finemap_eQTL/all_TRUE_hg19_retina_gencodeHg19_1000g_flt_pip_var_merged_new";
